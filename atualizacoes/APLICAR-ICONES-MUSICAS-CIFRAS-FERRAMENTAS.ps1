# Ministério Seven — aplicar ícones pontuais: música/cifra/ferramentas/cards
...
Write-Host ""
Write-Host "Icones de musicas/cifras/ferramentas/cards aplicados. Atualize com Ctrl + F5."
