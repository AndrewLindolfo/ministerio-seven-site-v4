# Ministério Seven — correção Downloads ativo preso na navegação suave
...
Write-Host ""
Write-Host "Correcao aplicada: Downloads nao fica mais ativo fora das paginas de downloads. Atualize com Ctrl + F5."
