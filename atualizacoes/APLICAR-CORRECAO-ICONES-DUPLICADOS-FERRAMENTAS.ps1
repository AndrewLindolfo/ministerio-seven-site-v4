# Ministério Seven — correção: ícones duplicados e card Ferramentas
# Execute na raiz da pasta do projeto.
...
Write-Host ""
Write-Host "Correcao aplicada: duplicados removidos e Ferramentas corrigido. Atualize com Ctrl + F5."
