...
$cssLine = '  <link rel="stylesheet" href="assets/css/seven-header-user-icon-fix.css" />'
...
foreach ($item in $htmlFiles) {
  ...
  if ($content -notmatch 'seven-header-user-icon-fix\.css') {
...
Write-Host ""
Write-Host "Correcao aplicada: icone de usuario deslogado ajustado. Atualize com Ctrl + F5."
