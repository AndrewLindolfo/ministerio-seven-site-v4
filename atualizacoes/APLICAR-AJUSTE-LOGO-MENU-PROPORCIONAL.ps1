# Ministério Seven V4 — ajuste da logo do menu público
...
$cssHref = 'assets/css/seven-logo-menu-proporcional.css'
$cssLine = '  <link rel="stylesheet" href="assets/css/seven-logo-menu-proporcional.css" />'
...
Write-Host ""
Write-Host "Ajuste aplicado: logo do menu publico reduzida e proporcional. Atualize com Ctrl + F5."
